...
\begin{abstract}
This report presents a comprehensive machine learning solution for predicting customer churn in the telecommunications industry. The project encompasses the complete data science pipeline, from exploratory data analysis through model deployment. Four classification models were developed and evaluated: Logistic Regression, Random Forest, XGBoost, and Neural Network. The best-performing model achieved an F1-Score of 62.3\% and ROC-AUC of 84.1\%. A production-ready web application was developed using FastAPI and Streamlit, enabling real-time churn prediction with actionable business recommendations. Analysis reveals that customer tenure and contract type are the strongest predictors of churn behavior.
\end{abstract}
